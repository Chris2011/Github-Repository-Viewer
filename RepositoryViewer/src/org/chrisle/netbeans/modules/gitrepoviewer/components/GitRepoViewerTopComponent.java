 ...
 */
@ConvertAsProperties(
        dtd = "-//org.chrisle.netbeans.modules.gitrepoviewer.components//RepoViewer//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "GitRepoViewerTopComponent",
        iconBase = "org/chrisle/netbeans/modules/gitrepoviewer/resources/world.png"
)
@TopComponent.Registration(mode = "explorer", openAtStartup = false)
@ActionID(category = "Window", id = "org.chrisle.netbeans.modules.gitrepoviewer.components.GitRepoViewerTopComponent")
@ActionReferences({
...
public final class GitRepoViewerTopComponent extends TopComponent {
    ...
    public GitRepoViewerTopComponent() {
        initComponents();
         ...
         _rootNodeIcon = ImageUtilities.image2Icon(ImageUtilities.loadImage("org/chrisle/netbeans/modules/gitrepoviewer/resources/world.png"));
