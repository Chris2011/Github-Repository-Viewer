...
public class AddHostDialog extends JDialog {
    ...
    private IHostService<IHost> _hostService = null;
    ...
    private List<IRepository> getRepositoriesFromHost() {
        return _hostService.getRepositoriesFromHost(_userCredentials.getUserName());
    }
    ...
    private User getUserFromFile() {
        try {
            ...
            UserRepository userRepository = new UserRepository(new Gson(), _dirName);
            _userService = new UserService(new User(_username.getText(), _authToken.getText()), userRepository);

            if (_fileReader != null) {
                userRepository.setFileReader(_fileReader);
            }
